<?php
$url = 'http://hexa.perl.sh/~carpedm30/snake/snake_secure.php';
$w = 540; // css 수정해야함
$h = 280; // css 수정해야함
...
function play_game() 
{
	...
	//var inc_score = 50;
	var color_array = ["#45C0CC","#809799","#38bf82","#FFD82D","#6E67E8","#4769FF","#49E8CD","#63EF80","#C735E8","#FF583A"];
	var color_array2 = ["#ADE0DD","#C9C9C7","#CBFFBC","#FFF39C","#8E8FE8","#96A5FF","#C1E8DD","#C9FFCF","#F97DE8","#FF9E89"];
